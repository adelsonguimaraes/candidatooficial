...
Class AgendaDAO {
	...
	function cadastrar (agenda $obj) {
		$this->sql = sprintf("INSERT INTO agenda(data, horario, descricao, datacastro)
		VALUES('%s', '%s', '%s', '%s')",
			...
			mysqli_real_escape_string($this->con, $obj->getDatacastro()));
	...
	function atualizar (Agenda $obj) {
		$this->sql = sprintf("UPDATE agenda SET data = '%s', horario = '%s', descricao = '%s', datacastro = '%s', dataedicao = '%s' WHERE id = %d ",
			mysqli_real_escape_string($this->con, $obj->getData()),
			mysqli_real_escape_string($this->con, $obj->getHorario()),
			mysqli_real_escape_string($this->con, $obj->getDescricao()),
			mysqli_real_escape_string($this->con, $obj->getDatacastro()),
